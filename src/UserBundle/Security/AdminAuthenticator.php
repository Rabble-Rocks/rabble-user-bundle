...
namespace Rabble\UserBundle\Security;
...
{
    private const LOGIN_ROUTE = 'rabble_admin_auth_login';
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        return $userProvider->loadUserByUsername((string) $credentials['username']);
    }
    ...
    {
        return new RedirectResponse($this->urlGenerator->generate('rabble_admin_dashboard'));
    }
